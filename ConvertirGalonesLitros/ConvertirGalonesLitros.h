...
protected:
	...
	void InitializeGui()
	{
		...
		tbxLitros.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 295, 37, 101, 25, hWnd, 1004);
